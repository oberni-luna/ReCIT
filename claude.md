...
- [0008 Automatic shelving with on-device AI](docs/features/0008-ai-auto-sort.md) — proposes étagères sized to the collection, reviewed before anything is written (amends the empty card in 0005)
